---
title: PostedSalesInvoiceWithQR (report)
...
* Reissue invoice copies for specific customers or invoice numbers when a customer requests a duplicate with payment details.,Controllers and finance teams can use the report to:
